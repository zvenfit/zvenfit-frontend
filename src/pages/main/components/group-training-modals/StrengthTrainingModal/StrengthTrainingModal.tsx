  ...
  return (
    <Modal title="Силовые тренировки" open={open} onClose={onClose}>
      <Layout img={IMAGE_URL}>
        ...
        <p>Наши тренеры помогут вам достичь результатов, основываясь на вашем опыте и целях. Мы предлагаем:</p>
        <ul>
        ...
        <p>
          Две пробные тренировки по 299₽ — приходите на силовые тренировки и начните преображение своего тела уже
          сейчас!
        </p>
        {/*Запишитесь через форму vk.cc/cDQudY и сделайте первый шаг к сильному и подтянутому телу!*/}
      </Layout>
    </Modal>
  );
};
