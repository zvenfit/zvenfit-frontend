...
const PRODUCTION = Object.freeze({
  ...
  scheduleProvider: 'fitbase',
  leadNotificationMode: 'telegram',
...
const STAGING = Object.freeze({
  ...
  scheduleProvider: 'fixture',
  leadNotificationMode: 'fixture',
...
function readConfig(env = process.env) {
  return {
    ...
    scheduleProvider: required(env.SCHEDULE_PROVIDER, 'SCHEDULE_PROVIDER'),
    leadNotificationMode: required(env.LEAD_NOTIFICATION_MODE, 'LEAD_NOTIFICATION_MODE'),
