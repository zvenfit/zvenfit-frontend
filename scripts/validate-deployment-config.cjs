...
const PRODUCTION = Object.freeze({
  ...
  trafficFunctionName: 'zvenfit-site-traffic',
...
const STAGING = Object.freeze({
  ...
  trafficFunctionName: 'zvenfit-site-traffic-staging',
...
function readConfig(env = process.env) {
  return {
    ...
    trafficFunctionName: required(env.TRAFFIC_FUNCTION_NAME, 'TRAFFIC_FUNCTION_NAME'),
